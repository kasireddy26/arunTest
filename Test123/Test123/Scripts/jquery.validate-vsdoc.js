 ...
 * terms; or (ii) using the files as included with a Microsoft UserInformation subject
 * to that UserInformation's license terms. Microsoft reserves all other rights to the
...
* standard jQuery library for all UserInformationion use.
*
